...
const userBulkUploadMulter = multer({
...
export function userBulkUploadMiddleware(req: Request, res: Response, next: NextFunction) {
  userBulkUploadMulter.single("file")(req, res, (error) => {
    if (!error) {
      next();
      return;
    }
